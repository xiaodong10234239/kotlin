...
fun defaultHostPreset(subproject: Project): TargetPreset {
    return when (HostManager.host) {
        ...
        KonanTarget.HARMONYOS_ARM64 -> subproject.kotlin::ohosArm64
        KonanTarget.HARMONYOS_X64 -> subproject.kotlin::ohosX64
...
fun targetHostPreset(
    ...
    return when(crossTarget) {
        ...
        "harmonyosArm64" -> subproject.kotlin::ohosArm64
        "harmonyosX64" -> subproject.kotlin::ohosX64
