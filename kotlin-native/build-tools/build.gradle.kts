...
//    val bootstrapKotlinVersion="2.1.255.1-SNAPSHOT"
    val bootstrapKotlinVersion=bootstrapKotlinVersion
    implementation("org.jetbrains.kotlin:kotlin-reflect:${bootstrapKotlinVersion}") { isTransitive = false }
    implementation("org.jetbrains.kotlin:kotlin-build-gradle-plugin:${kotlinBuildProperties.buildGradlePluginVersion}")
    println("bootstrapKotlinVersion=${project.bootstrapKotlinVersion}")
    api("org.jetbrains.kotlin:kotlin-native-utils:${bootstrapKotlinVersion}")
//    implementation(project(":native:kotlin-native-utils"))
    ...
    implementation("org.jetbrains.kotlin:kotlin-util-klib:${bootstrapKotlinVersion}")
}
