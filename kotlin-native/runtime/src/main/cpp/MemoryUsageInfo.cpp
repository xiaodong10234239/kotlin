...
#elif KONAN_LINUX || KONAN_MACOSX || KONAN_IOS || KONAN_TVOS || KONAN_WATCHOS || KONAN_OHOS
...
#elif KONAN_MACOSX || KONAN_IOS || KONAN_TVOS || KONAN_WATCHOS
    // On macOS, iOS, tvOS and watchOS it's in bytes.
