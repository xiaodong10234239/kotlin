...
sealed class KonanTarget(override val name: String, val family: Family, val architecture: Architecture) : Named, Serializable {
    ...
    object HARMONYOS_ARM64 : KonanTarget("harmonyos_arm64", Family.OHOS, Architecture.ARM64)
    object HARMONYOS_X64 : KonanTarget("harmonyos_x64", Family.OHOS, Architecture.X64)
    ...
    companion object {
        ...
        val predefinedTargets: Map<String, KonanTarget> by lazy {
            listOf(
                ...
                LINUX_X64,
                MINGW_X64,
                MACOS_X64, MACOS_ARM64,HARMONYOS_ARM64, HARMONYOS_X64,
