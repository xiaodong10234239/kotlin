...
interface HMOSConfigurables : Configurables, ClangFlags {
    val ohsdkHome get() = hostString("ohsdkHome")
    val sdkHome get() = DependencyDirectories.getLocalKonanDir()

    override val llvmHome: String?
        get() = ohsdkHome

    override val absoluteLlvmHome get() = "${sdkHome}/${ohsdkHome}/hms/native/BiSheng"

    override val targetToolchain: String?
        get() = ohsdkHome

    override val absoluteTargetToolchain: String
        get() = "${sdkHome}/${ohsdkHome}/hms/native/BiSheng"

    override val targetSysRoot: String?
        get() = ohsdkHome

    override val absoluteTargetSysRoot: String
        get() = "${sdkHome}/${ohsdkHome}/openharmony/native/sysroot"
}
