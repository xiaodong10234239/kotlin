...
private class KotlinHierarchyBuilderImpl(
    ...
    override fun withHarmonyOS() = withTargets {
        it is KotlinNativeTarget && it.konanTarget.family == Family.OHOS
    }

    override fun withHarmonyOSArm64() = withTargets {
        it is KotlinNativeTarget && it.konanTarget == KonanTarget.HARMONYOS_ARM64
    }

    override fun withHarmonyOSX64() = withTargets {
        it is KotlinNativeTarget && it.konanTarget == KonanTarget.HARMONYOS_X64
    }
