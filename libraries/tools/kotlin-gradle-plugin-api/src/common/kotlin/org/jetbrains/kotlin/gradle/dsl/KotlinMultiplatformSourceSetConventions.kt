...
interface KotlinMultiplatformSourceSetConventions {
    ...
    /**
     * Static accessor for shared kotlin Source Set between all declared harmony os targets.
     * Declare at least one of the targets mentioned above to access this source set.
     * If no targets were declared, accessing this source set will cause a runtime error during configuration time.
     *
     * Sample:
     ...
     *
     *    sourceSets {
     *      harmonyosMain.dependencies {
     *          // Add harmonyosMain dependencies here
     *      }
     *    }
     * }
     * ```
     ...
     * @since  2.0.20
     */
    val NamedDomainObjectContainer<KotlinSourceSet>.harmonyosMain: NamedDomainObjectProvider<KotlinSourceSet>
     ...
     *
     *    sourceSets {
     *      harmonyosTest.dependencies {
     *          // Add harmonyosTest dependencies here
     *      }
     *    }
     * }
     * ```
     ...
     * @since 2.0.20
     */
    val NamedDomainObjectContainer<KotlinSourceSet>.harmonyosTest: NamedDomainObjectProvider<KotlinSourceSet>
